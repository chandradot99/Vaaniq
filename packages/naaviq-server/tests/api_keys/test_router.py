"""
Integration tests for /v1/integrations — requires PostgreSQL naaviq_test database.
...
async def test_test_endpoint_openai_valid_key(client: AsyncClient, auth_headers: dict):
    ...
    with patch("naaviq.server.integrations.service.httpx.AsyncClient") as mock_client:
