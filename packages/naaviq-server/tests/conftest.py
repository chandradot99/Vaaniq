...
Uses a real PostgreSQL test database (naaviq_test).
Create it once before running tests locally:
    docker exec naaviq-postgres-1 psql -U naaviq -c "CREATE DATABASE naaviq_test;"

CI creates naaviq_test automatically in the workflow.
