...
from naaviq.server.integrations.exceptions import (
...
from naaviq.tools.providers import build_org_keys as _build_value
...
class PostgresCredentialStore(CredentialStore):
    ...
    Standalone developers who don't use naaviq-server should use
    naaviq-tools EnvCredentialStore instead.
    """
