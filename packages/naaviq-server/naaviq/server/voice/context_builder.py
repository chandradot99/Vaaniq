...
async def build_voice_context(
    ...
    # Emotion / expressiveness controls — all optional
    tts_emotion = vc.get("tts_emotion")
    tts_stability = vc.get("tts_stability")
    tts_style = vc.get("tts_style")
    tts_instructions = vc.get("tts_instructions")
