"""
LiveKit Worker entrypoint for vaaniq-voice-server.
...
Run locally:
    uv run python -m vaaniq.voice.worker --dev

Production (Fly.io):
    CMD ["uv", "run", "python", "-m", "vaaniq.voice.worker"]
"""
...
async def entrypoint(ctx: JobContext) -> None:
    ...
    try:
        from vaaniq.voice.agent import run_voice_agent
