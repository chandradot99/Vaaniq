...
Designed for developers using naaviq-tools directly in their own apps.
...
class EnvCredentialStore(CredentialStore):
    ...
    - CLI tools and scripts built on naaviq-tools
    ...
    Use naaviq-server's PostgresCredentialStore for multi-tenant use.
    """
